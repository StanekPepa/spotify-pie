...
<template>
    <div class="h-[calc(100vh-10rem)] w-full flex items-center justify-center ">
        <div class="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-xl text-center max-w-md w-11/12">
            <img src="../assets/Circle-icons-bar-chart.svg" alt="Spotify Logo" class="w-32 mx-auto mb-6" />
            <h1 class="text-2xl md:text-3xl font-bold text-white mb-2">Welcome to Spotify Stats</h1>
            <p class="text-gray-200 mb-8">View your music listening statistics</p>
